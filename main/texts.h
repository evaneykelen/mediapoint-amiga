...
#define FONT_WINDOW_TITLE					"Type & size"
#define STYLE_WINDOW_TITLE				"Style"
#define COLORADJUST_WINDOW_TITLE	"Color adjust"
#define PALETTE_WINDOW_TITLE			"Palette"
#define SAMPLE_WINDOW_TITLE				"Typeface example"

#define FORMAT_FORMAT_TEXT				"Format:"
#define FORMAT_OVERSCAN_TEXT			"Overscan:"
#define FORMAT_COLORS_TEXT				"Colors:"
#define FORMAT_SPECIAL_TEXT				"Special:"

#define DONTSAVE_TEXT1						"Save changes to the document"
#define DONTSAVE_TEXT2						"before closing?"
#define DONTSAVE_TEXT3						"Save changes to the script"

#define THUMBTEXT1								"First"
#define THUMBTEXT2								"Previous"

#define THUMBTEXT3								"Cancel"
#define THUMBTEXT4								"Grab"

#define THUMBTEXT5a								"Image too"
#define THUMBTEXT5b								"large."
...
#define UNTITLED_TEXT							"untitled"
#define COMMENT_TEXT							"comment"

#define DANAMES_TEXT							"No program selected"
...
#define	NO_DISK_TEXT							"No disk in drive"
...
#define TL_PlayFromDisk						"Play from disk"
#define TL_AddLoopFrames					"Add loop frames"
...
#define TEXT_TIMECODE_9						"SMPTE/EBU"
#define TEXT_TIMECODE_10					"MediaLink Time Code"
#define TEXT_TIMECODE_11					"25 FPS"
#define TEXT_TIMECODE_12					"30 FPS"
#define TEXT_TIMECODE_13					"Offset:"
#define TEXT_TIMECODE_14					"Send out"
#define TEXT_TIMECODE_15					"Preload:"

#define TEXT_TIMECODE_17					"Switching from HH:MM:SS:T to \
time code will discard all scheduling information."

#define TEXT_TIMECODE_18					"Switching from time code to HH:MM:SS:T \
will discard all frame codes."
...
#define TL_TextOnly								"Text Only"
#define TL_MultipleFiles					"Multiple files"
...
#define TL_StartUpScreen					"Page\0   Script\0 "
																 /*---------+++++++++*/

#define TL_ThumbNailSize					"Small\0 Large\0 "
																 /*--------++++++++*/

#define TL_RemapTo								"Grayscales\0 Colors\0     "
																 /*-------------+++++++++++++*/

#define TL_Timing									"Normal\0  Precise\0 "
																 /*----------++++++++++*/

#define TL_PREFS1									"General Preferences"
#define TL_PREFS2									"User level:"
#define TL_PREFS3									"Startup screen:"
#define TL_PREFS4									"Color set:"
#define TL_PREFS5									"Video format:"
#define TL_PREFS6									"Thumbnail size:"
#define TL_PREFS6a								"Thumb colors:"
#define TL_PREFS7									"Remap to:"
#define TL_PREFS8									"Thumbnails"
#define TL_PREFS9									"Page"
#define TL_PREFS10								"Script"
#define TL_PREFS11								"Script timing:"
#define TL_PREFS12								"Interlaced screens:"

#define TL_PREFS20								"Default Paths Preferences"
#define TL_PREFS21								"Import picture path:"
#define TL_PREFS22								"Import text path:"
#define TL_PREFS23								"Open document path:"
#define TL_PREFS24								"Save document path:"
#define TL_PREFS25								"Open script path:"
#define TL_PREFS26								"Save script path:"

#define TL_PreLoad								"None\0                       All after a label\0          All parallel branches too\0  All objects in main too\0    All objects\0                "
																 /*-----------------------------+++++++++++++++++++++++++++++-----------------------------+++++++++++++++++++++++++++++-----------------------------*/

#define TL_PlayOptions						"Automatic\0     Manual\0        Auto + Manual\0 "
																 /*----------------++++++++++++++++----------------*/

#define TL_PREFS30								"Script Preferences"
#define TL_PREFS31								"Programmable time codes:"
#define TL_PREFS32								"F1:"
#define TL_PREFS33								"F2:"
#define TL_PREFS34								"F3:"
#define TL_PREFS35								"F4:"
#define TL_PREFS36								"F5:"
#define TL_PREFS37								"F6:"
#define TL_PREFS38								"Script object pre-loading:"
#define TL_PREFS39								"Play options:"
#define TL_PREFS40								"Display options:"
#define TL_PREFS41								"Show transitions"
#define TL_PREFS42								"Show Prog"
#define TL_PREFS43								"Show Days"

#define TL_PREFS50								"Player Device Preferences"
#define TL_PREFS51								"Player device:"
#define TL_PREFS52								"Baud rate:"
#define TL_PREFS53								"Serial device:"
#define TL_PREFS54								"Unit:"

#define TL_PREFS55								"No device selected"
...
#define USERLEVEL_CONFLICT				"The script is too elaborate for the\
 chosen user level. Shall I close the script or ignore the user level?"
#define TL_IGNORE									"Ignore"
#define TL_CLOSE									"Close"

#define TL_MODTYPE1								"Mark II"
#define TL_MODTYPE2								"DSS"
#define TL_MODTYPE3								"Soundtracker 15"
#define TL_MODTYPE4								"Sound/Noise/Protracker"
#define TL_MODTYPE5								"Future Composer 1.3"
#define TL_MODTYPE6								"Future Composer 1.4"
#define TL_MODTYPE7								"JamCracker"
#define TL_MODTYPE8								"SoundMonitor"
#define TL_MODTYPE9								"Unknown type"

/**** script manager ****/

#define TL_SC1										"MediaLink› Script Manager"
#define TL_SC2										"Check and repair paths\0 Replace all paths\0      Make runtime disk(s)\0   Move script and data\0   "
																 /*-------------------------+++++++++++++++++++++++++-------------------------+++++++++++++++++++++++++*/
#define TL_SC3										"Start"
#define TL_SC4										"Replace"
#define TL_SC5										"By:"
#define TL_SC6										"Select file"
#define TL_SC7										"Find file"
#define TL_SC8										"Exit"

#define TL_EFFECTSPEED						"Speed:"
#define TL_CHUNCKSIZE							"Chunck Size:"
