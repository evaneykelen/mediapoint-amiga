...
dbstr:		dc.b	"Remove player",10,0

_Interrupt	movem.l	d1-d7/a0-a6,-(sp)
		move.l	_CurrentMod,a0
		move.l  12(a0),a0
		move.l	_displace(pc),d0
;		move.l	#19,d0
		add.l	#16,_count
		cmp.l	_count,d0
		bgt	.skip
...
_SetupPlayer
		move.l	4(sp),d0
		movem.l	a2-a6/d2-d6,-(sp)       ;returns 0 on success
		move.l	d0,_displace
		bsr	AllocAudio
		tst.l	d0
		bne.s	AudioErr
...
proc50hnaam:	dc.b	"Music interupt",0
	even
		
intstruct50h:
	dc.l	0,0
	dc.b	2,-127	; type en pri
