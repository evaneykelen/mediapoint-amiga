...
PALTimerSpeed		equ	14187
NTSCTimerSpeed		equ	14318

	section	functions,code
	dc.b	'$VER: MediaLink Player v1.0',10
	dc.b	'      ©1992 by Mike Kennedy',10,0
	even
;----------------------------------------------------------------------------
...
_Interrupt	movem.l	d0-d7/a0-a6,-(sp)
		move.l	_CurrentMod,a0
		move.l  12(a0),a0
		jsr	(a0)
