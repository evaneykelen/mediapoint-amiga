...
filename:	dc.b	"tpics:back2.24",0
...
ppp:
	movem.w	(a7)+,d0/d1/d2		; retrieve rgb values
	IFNE	0
	move.b	(a0),d3
	addq.l	#1,a0
	subq.w	#1,d3
...
.rep_ac:
	...
	sub.w	0(a2,d4.w),d0		; compare this with the rgb values
	bpl	.no1
	neg.w	d0
.no1:	
	sub.w	2(a2,d4.w),d1
