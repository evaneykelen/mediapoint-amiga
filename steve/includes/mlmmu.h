...
#define MEMF_USED	1<<17			// Internal use only, if set at FlushMem
									// areas which are used will also be freed
#define MEMF_ALL	1<<16			// Internal use only, if set at FlushMem
									// all areas will be freed except for when they 
									// are in use.

#define MEMF_STAY 	1<<15			// mt_Attr, do not free this memory
