...
struct StringRecord CSV_single_SR		= { 2, "   " };
struct StringRecord CSV_from_SR			= { 2, "   " };
struct StringRecord CSV_to_SR				= { 2, "   " };
struct StringRecord CSV_duration_SR	= { 2, "   " };

struct GadgetRecord CSV_GR[] =
{
  0,   0, 411, 188, 0, NULL, 0,													DIMENSIONS, NULL,
  0,	 0,	410, 187, 0, NULL,	0,												DBL_BORDER_REGION, NULL,
 21,  46,  37,  54, 1, NULL, Msg_X_I_2,									RADIO_GADGET, NULL,
 21,  60,  37,  68, 1, NULL, Msg_X_I_3,									RADIO_GADGET, NULL,
157,  44, 187,  57, 1, NULL,	0,												INTEGER_GADGET, (struct GadgetRecord *)&CSV_single_SR, 
190,  58, 220,  71, 1, NULL,	0,												INTEGER_GADGET, (struct GadgetRecord *)&CSV_from_SR, 
260,  58, 290,  71, 1, NULL, Msg_X_I_4,									INTEGER_GADGET, (struct GadgetRecord *)&CSV_to_SR, 
186,  82, 216,  95, 1, NULL, Msg_X_I_5,									INTEGER_GADGET, (struct GadgetRecord *)&CSV_duration_SR,
 21, 110,  37, 118, 1, NULL, Msg_X_I_7,									CHECK_GADGET, NULL,
...
150,   3, 406,  12, 1, NULL, Msg_X_I_1, 								TEXT_RIGHT, NULL,
150,  14, 406,  23, 1, NULL, Msg_X_1,										TEXT_RIGHT, NULL,
 21,  76, 388,  76, 0, NULL,	0,												LO_LINE, NULL, 
 21, 101, 388, 101, 0, NULL,	0,												LO_LINE, NULL, 
 21, 127, 388, 127, 0, NULL,	0,												LO_LINE, NULL, 
302, 110, 318, 118, 1, NULL, Msg_X_I_8,									CHECK_GADGET, NULL,
 21, 133, 158, 145, 0, NULL, Msg_X_I_9,									BUTTON_GADGET, NULL,
