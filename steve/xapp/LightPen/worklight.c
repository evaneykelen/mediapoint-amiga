...
extern void GetExtraData(PROCESSINFO *ThisPI, struct lp *lp );
...
// Send init-ready message to your guide
	...
	while(!B_Term)
	{
		...
		SigRecvd = Wait( Sig_PtoC | SigR_CtoP | SIGF_ABORT| SigLp );
