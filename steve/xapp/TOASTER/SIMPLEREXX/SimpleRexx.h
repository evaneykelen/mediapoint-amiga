...
short SendARexxMsg(AREXXCONTEXT,char *,short,struct FileHandle *);
...
struct FileHandle *OpenTalkFile(STRPTR);
void CloseTalkFile(STRPTR,struct FileHandle *);
BOOL IssueRexxCmdNoRet(char *);
